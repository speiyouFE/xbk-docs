<template>
  <div class="theme-container not-found">
    <svg class="me404" viewBox="0 0 1000 480">
      ...
      />
      <router-link to="/">
        <text x="360" y="330" class="text">{{ getMsg() }}</text>
      </router-link>
      <g id="triforce">
        <path
          id="zelda_stroke"
      ...
      <g id="moon">
        ...
        />
        <a xlink:href="/">
          <text x="610" y="90" class="text">My God</text>
        </a>
      </g>
      <g id="number_4">
        <path
      ...
      <!-- <g id="random_text">
        <path id="random_text_body" class="st5" d="M681,320c26,0,47,21,47,47s-21,100-100,47s-47-21-47-47S625,330,300,300z"/>
        <text x="610" y="370" class="text">{{getMsg()}}</text>
      </g> -->
    </svg>
    <!-- <div class="content">
      <h1>404</h1>
...
<script>
const msgs = [`你怎么会来到这儿了啊？`, `你确定没瞎整么?`, `这好像是个404页面.`]
...
#random_text {
  transform-origin: 200px 81px;
  -webkit-animation: text-float 6s infinite ease-in-out;
  -moz-animation: text-float 6s infinite ease-in-out;
  -o-animation: text-float 6s infinite ease-in-out;
