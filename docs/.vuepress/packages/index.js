...
import Icon from './scicon/index.js'
...
const components = [Card, Button, Dialog, Tabs, TabPane, Input, Select, Option, OptionGroup, Scrollbar, Lottie, Dropdown, DropdownMenu, DropdownItem, Popover, Countup, Countdown, QrCode, Icon]
const version = '1.0.1'
