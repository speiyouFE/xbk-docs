...
function getRtcSiderBar(groupTitle) {
  return [
    ...
    },
    {
      ...
      sidebarDepth: 0,
      children: [
        "player/setPlayerMuteByUserID",
        "player/setPlayerMuteByPlayerID",
        "player/destroyPlayerByUserID",
        "player/destroyPlayerByPlayerID"
      ]
    },
    {
      title: "其他",
